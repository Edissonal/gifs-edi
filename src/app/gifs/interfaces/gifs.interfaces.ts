...
export enum Title {
  Empty = "",
  IAmJojoWhenLoveHurtsGIFByJoJo = "i am jojo when love hurts GIF by JoJo",
  TheBacheloretteKissGIF = "the bachelorette kiss GIF",
}
...
const typeMap: any = {
  ...
  "Title": [
      "",
      "i am jojo when love hurts GIF by JoJo",
      "the bachelorette kiss GIF",
  ],
  "TrendingDatetime": [
      "0000-00-00 00:00:00",
  ],
